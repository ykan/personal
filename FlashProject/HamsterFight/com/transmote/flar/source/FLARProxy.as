...
package com.transmote.flar.source {
	...
	public class FLARProxy extends Sprite implements IFLARSource {
		...
		public function activate () :void {
			if (this.stage) {
				this.mouseArea.addEventListener(MouseEvent.MOUSE_DOWN, this.onmusedown, false, 0, true);
		...
		public function deactivate () :void {
			if (this.stage) {
				this.mouseArea.removeEventListener(MouseEvent.MOUSE_DOWN, this.onmusedown);
		...
		private function onmusedown (evt:MouseEvent) :void {
